...
class OrderStatisticsServiceTest {
    ...
    @DisplayName("결재완료 주문들을 조회하여 매출 통계를 전송한다.")
    @Test
    void sendOrderStatisticsMail() {
        ...
        Order order1 = createPaymentCompleteOrder(LocalDateTime.of(2023, 3, 4, 23, 59, 59),
            products);
        Order order2 = createPaymentCompleteOrder(now, products);
        Order order3 = createPaymentCompleteOrder(LocalDateTime.of(2023, 3, 5, 23, 59, 59),
            products);
        Order order4 = createPaymentCompleteOrder(LocalDateTime.of(2023, 3, 6, 0, 0), products);

        Mockito.when(
            mailSendClient.sendMail(any(String.class), any(String.class), any(String.class),
        ...
        assertThat(histories).hasSize(1).extracting("content")
