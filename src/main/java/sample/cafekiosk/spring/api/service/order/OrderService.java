...
public class OrderService {
    ...
    private static List<String> extractStockProductMember(List<Product> products) {
    ...
    private void deductStockQuantities(List<Product> products) {
        ...
        List<String> stockProductNumbers = extractStockProductMember(products);

        // 재고 엔티티 조회
        List<Stock> stocks = stockRepository.findAllByProductNumberIn(stockProductNumbers);
        Map<String, Stock> stockMap = createStockMapBy(stocks);

        // 상품별 counting -> 재고 차감 시도
